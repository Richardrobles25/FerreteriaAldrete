...
<style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .filtro-group select:focus { outline: none; border-color: #ff8c00; }
    ...
    .rank { font-size: 16px; font-weight: 700; color: #ff8c00; }
    .rank-1 { color: #f57f17; }
    .rank-2 { color: #9e9e9e; }
    .rank-3 { color: #8d6e63; }
    .barra-container { width: 100%; background: #f0f0f0; border-radius: 99px; height: 6px; margin-top: 4px; }
    .barra { background: #ff8c00; border-radius: 99px; height: 6px; }
