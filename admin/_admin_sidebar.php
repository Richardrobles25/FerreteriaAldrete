...
function renderAdminSidebar(string $activeKey): void
{
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <a class="menu-item<?= $isActive('gastos_categorias') ?>" href="gastos_categorias.php">Categorias de gasto</a>
            <div class="divider"></div>
            ...
            <div id="inventarioSubmenu" <?= $submenuStyle($inventarioOpen) ?>>
                ...
                <a class="menu-item<?= $isActive('inventario_promociones') ?>" href="promociones.php" style="padding-left:28px;">Promociones</a>
            </div>
