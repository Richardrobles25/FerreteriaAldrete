...
if ($busqueda) {
    $where .= " AND c.nombre_completo LIKE ?";
    $params[] = '%'.$busqueda.'%';
}
if ($estado) {
    $where .= " AND cr.estado = ?";
...
<style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .btn-abonar { background: #e8f5e9; color: #2e7d32; }
    .btn-abonar:hover { background: #c8e6c9; }
    ...
    <div class="content">
        ...
        <form method="GET">
            <div class="filtros">
                ...
                <?php if ($busqueda || $estado): ?><a class="btn-limpiar" href="cajero_creditos.php">Limpiar</a><?php endif; ?>
            </div>
        </form>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="acciones">
                                <?php if ($cr['estado'] === 'Activo'): ?>
                                    <a class="btn-accion btn-abonar" href="cajero_abonos.php?credito_id=<?= $cr['credito_id'] ?>">Abonar</a>
                                <?php endif; ?>
                                <a class="btn-accion btn-ver" href="cajero_abonos.php?ver=<?= $cr['credito_id'] ?>">Ver abonos</a>
                            </div>
                        </td>
                    </tr>
                    <?php endforeach; ?>
