...
<style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .badge-pendiente { background: #fff3e0; color: #e65c00; }
    .sin-resultados { padding: 40px; text-align: center; color: #aaa; font-size: 14px; }
    .btn-ver { background: #fff3e0; color: #e65c00; border: none; padding: 4px 10px; border-radius: 5px; font-size: 12px; font-weight: 600; cursor: pointer; text-decoration: none; display: inline-block; }
</style>
