...
<style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .alerta-pend { background: #fff3e0; border: 1px solid #ffe0b2; border-radius: 8px; padding: 12px 16px; font-size: 13px; color: #e65c00; margin-bottom: 18px; }
    ...
    .dif-sobrante { background: #fff8e1; color: #f57f17; }
        ...
        <div>
            <div class="card">
                ...
                <div class="alerta-pend">
                    ...
                    <a href="ventasPendientes.php" style="color:#e65c00;font-weight:700;margin-left:6px;">Ver</a>
                </div>
                <?php endif; ?>
