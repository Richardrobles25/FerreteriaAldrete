...
<div class="main">
    ...
    <div class="content">
        ...
        <div class="alerta-stock">
            ...
            <div class="alerta-item">
                ...
                <div>
                    ...
                    <a href="inventario_entradas.php?producto_id=<?= $p['producto_id'] ?>"
        ...
        <div class="notif-transf">
            ...
            <a href="inventario_transferencias.php" style="margin-left:16px;white-space:nowrap;">Ver</a>
        </div>
        <?php endif; ?>
        ...
        <div class="grid-2">
            ...
            <div class="tabla">
                <div class="tabla-header">
                    ...
                    <a href="inventario_compras.php">Ver todas</a>
                </div>
