...
<style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .breadcrumb a { color: #ff8c00; text-decoration: none; }
    .info-credito { background: #fff5e6; border: 1px solid #ffe0b2; border-radius: 8px; padding: 14px 16px; margin-bottom: 16px; }
    ...
    .credito-item:hover { border-color: #ff8c00; }
    .btn-seleccionar { background: #ff8c00; color: white; border: none; padding: 7px 14px; border-radius: 5px; font-size: 12px; font-weight: 600; cursor: pointer; text-decoration: none; display: inline-block; }
</style>
