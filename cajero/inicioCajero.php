...
<div class="sidebar" id="sidebar">
    ...
    <div class="sidebar-menu">
        <a class="menu-item active" href="inicioCajero.php">Inicio</a>
    ...
    <div class="content">
        ...
        <?php if ($cajaActual): ?>
            <div class="caja-status caja-abierta">
                ...
                <a class="btn-caja btn-cerrar-caja" href="corteCaja.php">Cerrar caja</a>
            </div>
        <?php else: ?>
            <div class="caja-status caja-cerrada">
                ...
                <a class="btn-caja btn-abrir-caja" href="abrirCaja.php">Abrir caja</a>
            </div>
        <?php endif; ?>
